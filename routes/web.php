...
Route::controller(LayoutController::class)->group(function () {
    Route::post('/switch-layout', 'switchLayout')->name('switchLayout');
    Route::get('/get-layout', 'getLayout')->name('getLayout');
    Route::post('/reset-layout', 'resetLayout')->name('resetLayout');
});
